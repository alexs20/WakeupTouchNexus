...
public class SideViewBackwardDialogIcon extends AngleDialogIcon {

	private int mAngleTo;

	public SideViewBackwardDialogIcon(Context context) {
		super(context);
	}
	...
	public void setValue(int value) {
		setIconAngle(value);
		setArcAngleFrom(value);
		setArcAngleTo(mAngleTo);
		invalidate();
	}
